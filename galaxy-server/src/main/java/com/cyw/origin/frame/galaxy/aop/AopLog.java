...
//import com.weimob.saas.message.common.utils.FastJsonUtils;
//import com.weimob.saas.sms.remote.service.SaasSmsPackageUserRemoteService;
//import com.weimob.saas.sms.remote.service.dto.request.LogAddRequestDTO;
...
//    @Autowired
//    private SaasSmsPackageUserRemoteService saasSmsPackageUserRemoteService;
//
//
...
//
//    @Around("execution(* com.weimob.saas.promotion.controller..*(..)) || execution(* com.weimob.saas.promotion.service..*(..))" )
...
//                    String description = String.format("请求参数：%s， 返回参数：%s", params, FastJsonUtils.beanToJson(object));
//                    String systemName = request.getAttribute("systemName") != null ? (String) request.getAttribute("systemName") : "";
//
//                    LogAddRequestDTO requestDTO = new LogAddRequestDTO();
//                    requestDTO.setUsername(username);
//                    requestDTO.setAccount(account);
//                    requestDTO.setMenuName(menuName);
//                    requestDTO.setOperationType(operationType);
//                    requestDTO.setDescription(description);
//                    requestDTO.setSystemName(systemName);
//                    saasSmsPackageUserRemoteService.logAdd(requestDTO);
//                }
